...
const CreateWarehouse = () => {
  ...
  const { createWarehouse, loading, error, warehouseExists } = useWarehouse();
  ...
  useEffect(() => {
    if (warehouseExists) {
      setFormErrors(prev => ({
        ...prev,
        warehouse_name: 'Warehouse already exists. Only one warehouse is allowed.'
      }));
    }
  }, [warehouseExists]);
    ...
    <Card title="Create Warehouse">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Button
          ...
          fullWidth
          loading={loading}
          disabled={loading || warehouseExists}
        >
          Create Warehouse
        </Button>
      </form>
